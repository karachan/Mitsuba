...
<tbody>
<?php
$result = $conn->query("SELECT users.*, groups.name AS gname FROM users LEFT JOIN groups ON users.group=groups.id ORDER BY FIELD(gname, 'Administrator', 'Moderator+', 'Moderator', 'Janitor', 'Disabled'), users.username;");
